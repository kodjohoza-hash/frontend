...
export const ROUTE_PERMISSIONS = {
  ...
  [ROUTES.COMPANY_PAYMENTS]: { roles: ['company_admin'], permissions: [PERMISSIONS.PAYMENTS_VIEW] },
  [ROUTES.COMPANY_CLIENTS]: { roles: ['company_admin'], permissions: [PERMISSIONS.BOOKINGS_VIEW] },
  [ROUTES.COMPANY_COUNTERS]: { roles: ['company_admin'], permissions: [PERMISSIONS.COUNTERS_VIEW] },
  [ROUTES.COMPANY_COUNTER_AGENTS]: { roles: ['company_admin'], permissions: [PERMISSIONS.COUNTERS_VIEW] },
  [ROUTES.COMPANY_COUNTER_AGENT_DETAIL]: { roles: ['company_admin'], permissions: [PERMISSIONS.COUNTERS_VIEW] },
  [ROUTES.COMPANY_BRANCHES]: { roles: ['company_admin'], permissions: [PERMISSIONS.COUNTERS_VIEW] },
  [ROUTES.COMPANY_BRANCH_DETAIL]: { roles: ['company_admin'], permissions: [PERMISSIONS.COUNTERS_VIEW] },
  ...
  [ROUTES.COMPANY_MESSAGES]: { roles: ['company_admin'], permissions: [PERMISSIONS.MESSAGES_VIEW] },
  [ROUTES.COMPANY_SUBSCRIPTION]: { roles: ['company_admin'], permissions: [PERMISSIONS.SETTINGS_VIEW] },
  ...
  [ROUTES.COUNTER_NOTIFICATIONS]: { roles: ['counter_agent'], permissions: [PERMISSIONS.NOTIFICATIONS_VIEW] },
  [ROUTES.COUNTER_MESSAGES]: { roles: ['counter_agent'], permissions: [PERMISSIONS.MESSAGES_VIEW] },
