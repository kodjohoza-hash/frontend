    ...
    <AuthShell>
      <div className="auth-card">
        <div className="auth-header">
          ...
          <h2 className="auth-header__title">Connexion Client</h2>
          <p className="auth-header__subtitle">Connectez-vous pour réserver vos voyages</p>
        </div>
        ...
        <p className="auth-form__alt" style={{ marginTop: '1rem' }}>
          Pas encore inscrit ?{' '}
          <Link to="/auth/register/client" className="auth-form__alt-link">Créer un compte</Link>
        </p>
