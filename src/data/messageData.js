...
export const conversations = [
  {
    ...
    messages: buildMessages('conv_001', [
      ...
      ['ag_001', 'Le tarif est de 4 500 XAF en standard, 6 000 XAF en confort.'],
  ...
  },
  {
    ...
    messages: buildMessages('conv_003', [
      ...
      ['ag_001', 'Oui, je l\'ai consulté ce matin. Très bon chiffre ! 2 850 000 XAF de recettes.'],
  ...
  },
  {
    ...
    messages: buildMessages('conv_007', [
      ...
      ['ag_001', 'Deux places confort pour Garoua, départ 22h. Le tarif est de 12 000 XAF par personne.'],
  ...
  },
  {
    ...
    messages: buildMessages('conv_015', [
      ...
      ['co_015', 'C\'est vraiment inadmissible. J\'ai payé 6 000 XAF pour rien.'],
      ['ag_001', 'Je vous rembourse la différence de 1 500 XAF et vous offre un bon de 2 000 XAF.'],
