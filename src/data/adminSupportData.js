...
export const tickets = [
  ...
  {
    id: 'TKT-2026-0002', subject: 'Demande de remboursement — voyage annulé', description: 'Mon voyage Yaoundé → Douala du 25 juillet a été annulé par la compagnie. Je souhaite obtenir un remboursement complet de mon billet (12 500 XAF).',
    ...
    messages: [
      { id: 'msg_006', ticketId: 'TKT-2026-0002', author: 'usr_005', content: 'Mon voyage Yaoundé → Douala du 25 juillet a été annulé par la compagnie. Je souhaite obtenir un remboursement complet de mon billet (12 500 XAF).', createdAt: '2026-07-29 08:00', type: 'public', attachments: [] },
    ],
    timeline: [
...
export const knowledgeArticles = [
  ...
  { id: 'kb_009', title: 'Programme de fidélité', category: 'article', summary: 'Tout savoir sur le programme de fidélité BUS TIX CONNECT.', content: 'Notre programme de fidélité vous permet de cumuler des points à chaque réservation. 1 XAF dépensé = 1 point. 1000 points = 5 000 XAF de réduction. Les points sont valables 12 mois.', tags: ['fidélité', 'points', 'réduction'], views: 3400, helpful: 3100, createdAt: '2026-06-01', updatedAt: '2026-07-10', author: 'Admin Guillaume', favorites: 520 },
