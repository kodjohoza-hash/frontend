...
export const adminStats = [
  ...
  { id: 'revenue', label: "Chiffre d'affaires", value: '285 000 000', suffix: 'XAF', icon: 'bi-graph-up-arrow', color: 'success', trend: 35, trendUp: true },
  { id: 'commission', label: 'Commission BTC', value: '14 250 000', suffix: 'XAF', icon: 'bi-cash-coin', color: 'primary', trend: 28, trendUp: true },
...
export const activityTimeline = [
  ...
  { id: 4, type: 'booking', icon: 'bi-calendar-check', color: 'info', action: 'Nouvelle réservation', detail: 'BK-2026-1950 — Yaoundé → Douala — 12 500 XAF', time: '10:05' },
  { id: 5, type: 'payment', icon: 'bi-cash-coin', color: 'success', action: 'Paiement reçu', detail: 'TXN-001 — Express Bus — 1 250 000 XAF', time: '09:30' },
...
export const alerts = [
  ...
  { id: 2, type: 'danger', title: 'Paiement échoué', message: 'TXN-005 — 1 780 000 XAF — Touristique Express — Échec de transaction', time: '4h' },
