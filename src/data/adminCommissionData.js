...
export const commissionRules = [
  { id: 'rule_001', name: 'Commission standard', description: 'Commission par défaut sur toutes les ventes', type: 'percentage', value: 5, currency: 'XAF', minFee: 100, maxFee: 5000, startDate: '2024-01-01', endDate: null, priority: 0, status: 'active', appliesTo: 'all', companyId: null, city: null, country: null, minTickets: null, tripType: null, promotion: null },
  { id: 'rule_002', name: 'Premium réduit', description: 'Commission réduite pour compagnies Premium', type: 'percentage', value: 3, currency: 'XAF', minFee: 50, maxFee: 3000, startDate: '2024-06-01', endDate: null, priority: 1, status: 'active', appliesTo: 'subscription', companyId: null, city: null, country: null, minTickets: null, tripType: null, promotion: 'plan_business', subscriptionPlanId: 'plan_business' },
  { id: 'rule_003', name: 'Forfait international', description: 'Commission fixe pour trajets internationaux', type: 'fixed', value: 1500, currency: 'XAF', minFee: null, maxFee: null, startDate: '2024-03-01', endDate: null, priority: 2, status: 'active', appliesTo: 'trip_type', companyId: null, city: null, country: null, minTickets: null, tripType: 'international', promotion: null },
  { id: 'rule_004', name: 'Promo Nouvel An', description: 'Commission réduite pour les fêtes', type: 'percentage', value: 2, currency: 'XAF', minFee: 0, maxFee: 2000, startDate: '2024-12-20', endDate: '2025-01-15', priority: 3, status: 'expired', appliesTo: 'promotion', companyId: null, city: null, country: null, minTickets: null, tripType: null, promotion: 'new_year_2025' },
  { id: 'rule_005', name: 'Commission Express Bus', description: 'Commission spéciale Express Bus', type: 'percentage', value: 4, currency: 'XAF', minFee: 0, maxFee: 4000, startDate: '2024-05-01', endDate: null, priority: 4, status: 'active', appliesTo: 'company', companyId: 'comp_1', city: null, country: null, minTickets: null, tripType: null, promotion: null },
  { id: 'rule_006', name: 'Volume élevé', description: 'Commission réduite pour volumes élevés de billets', type: 'percentage', value: 3.5, currency: 'XAF', minFee: 0, maxFee: 3500, startDate: '2024-07-01', endDate: null, priority: 5, status: 'active', appliesTo: 'volume', companyId: null, city: null, country: null, minTickets: 1000, tripType: null, promotion: null },
  { id: 'rule_007', name: 'Forfait Douala-Yaoundé', description: 'Commission fixe sur axe principal', type: 'fixed', value: 500, currency: 'XAF', minFee: null, maxFee: null, startDate: '2024-04-01', endDate: null, priority: 6, status: 'active', appliesTo: 'city', companyId: null, city: 'Douala', country: 'Cameroun', minTickets: null, tripType: null, promotion: null },
  { id: 'rule_008', name: 'Mixte voyage long', description: 'Fix + % pour longs trajets', type: 'mixed', value: 3, fixedPart: 200, currency: 'XAF', minFee: null, maxFee: 5000, startDate: '2024-02-01', endDate: null, priority: 7, status: 'active', appliesTo: 'trip_type', companyId: null, city: null, country: null, minTickets: null, tripType: 'long_distance', promotion: null },
  { id: 'rule_009', name: 'Par billet standard', description: 'Commission fixe par billet vendu', type: 'per_ticket', value: 200, currency: 'XAF', minFee: null, maxFee: null, startDate: '2024-01-15', endDate: null, priority: 8, status: 'inactive', appliesTo: 'all', companyId: null, city: null, country: null, minTickets: null, tripType: null, promotion: null },
  { id: 'rule_010', name: 'Nouveau partenaire', description: 'Commission réduite première année', type: 'percentage', value: 2.5, currency: 'XAF', minFee: 0, maxFee: 2000, startDate: '2025-01-01', endDate: '2025-12-31', priority: 9, status: 'active', appliesTo: 'promotion', companyId: null, city: null, country: null, minTickets: null, tripType: null, promotion: 'new_partner_2025' },
];
...
export const commissionTimeline = [
  { id: 'ct_01', action: 'payment', title: 'Paiement reçu', description: 'COM-2025-0001 — Express Bus — 250 XAF', time: '2025-06-18 10:30', user: 'Système' },
  { id: 'ct_02', action: 'payment', title: 'Paiement reçu', description: 'COM-2025-0002 — Touristique Express — 175 XAF', time: '2025-06-17 14:15', user: 'Système' },
  ...
  { id: 'ct_06', action: 'payment', title: 'Paiement reçu', description: 'COM-2025-0005 — Express Bus — 200 XAF', time: '2025-06-14 08:45', user: 'Système' },
  ...
  { id: 'ct_08', action: 'revision', title: 'Révision trimestrielle', description: 'Augmentation des plafonds — max 5000 XAF', time: '2025-04-01 09:00', user: 'Système' },
];
