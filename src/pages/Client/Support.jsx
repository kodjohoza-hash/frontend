  ...
  return (
    <div className="sp-page">
      <div className="sp-page__header">
        ...
        <button type="button" className="sp-btn sp-btn--primary" onClick={() => { const el = document.getElementById('sp-ticket'); if (el) el.scrollIntoView({ behavior: 'smooth', block: 'start' }); }}>
          <i className="bi bi-plus-lg" /> Créer une demande
        </button>
      </div>
