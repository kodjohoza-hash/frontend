          ...
          <div className="auth-right__inner">
            <AuthCard>
              <div className="auth-status">
                ...
                <p className="auth-status__text">Votre compte a été activé. Connectez-vous maintenant.</p>
        ...
        <div className="auth-right__inner">
          ...
          <AuthCard>
            ...
            <form onSubmit={handleSubmit(onSubmit)} className="auth-form" noValidate>
              ...
              <AuthInput label="Code de vérification" name="code" placeholder="000000"
          ...
          <div className="auth-footer">
            <p className="auth-footer__text">
              <Link to="/login" className="auth-footer__link"><i className="bi bi-arrow-left me-1" /> Retour à la connexion</Link>
            </p>
          </div>
        </div>
      </div>
